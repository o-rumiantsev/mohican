...
MongoProvider.prototype.update = function(entry, callback) {
...
MongoProvider.prototype.delete = function(filter, callback) {
...
MongoProvider.prototype.drop = function(category, callback) {
  const collection = this.database.collection(category);
  collection.drop(callback);
};

MongoProvider.prototype._getMaxId = function(entries) {
