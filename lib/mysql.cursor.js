...
const MySQLCursor = function(
  // Mohican MySQL cursor constructor
...
MySQLCursor.prototype.project = function(
  // Specify fields to fetch
  fields // string or array of strings, fields names
) {
...
MySQLCursor.prototype.order = function(
  ...
  fields // string or array of strings, fields to order by
) {
...
MySQLCursor.prototype.distinct = function(
  ...
  if (!fields) {
    distinct = `DISTINCT ${this._fields}`;
...
MySQLCursor.prototype.toSQLString = function() {
  ...
  const fields = this._distinct || this._fields;
